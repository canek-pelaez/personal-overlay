...
# $Header: /var/cvsroot/gentoo-x86/sys-fs/udisks/udisks-2.0.92.ebuild,v 1.1 2013/03/05 12:26:06 ssuominen Exp $

EAPI=5
inherit autotools bash-completion-r1 eutils flag-o-matic linux-info systemd udev
...
src_prepare() {
	use systemd && epatch "${FILESDIR}/udisks-2.0.92-libsystemd-id128.patch" && eautoreconf
